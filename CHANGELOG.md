...
## [3.7.0-alpha.78] - 2026-06-11

### Changed
- Bump version `3.7.0-alpha.74` → `3.7.0-alpha.78` across all three packages (`claude-flow`, `ruflo`, `@claude-flow/cli`)
- Sync stale `v3/@claude-flow/cli` dependency pins to match root `package.json` — these drifted despite being listed as fixed in the alpha.74 CHANGELOG
...
Supersedes PR #27 (`claude/focused-rubin-4vfpjs`).
...
| **Ruflo v3.7-alpha.78** | **v3.7.0-alpha.78** | **2026-06-11** | **Dep sync, version alignment** |
