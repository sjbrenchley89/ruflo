...
## [3.7.0-alpha.80] - 2026-06-22

### Changed
- Bump version `3.7.0-alpha.79` → `3.7.0-alpha.80` across all three packages (`claude-flow`, `ruflo`, `@claude-flow/cli`)
...
## [3.7.0-alpha.79] - 2026-06-21

### Changed
- Bump version `3.7.0-alpha.78` → `3.7.0-alpha.79` across all three packages (`claude-flow`, `ruflo`, `@claude-flow/cli`)
- Daily maintenance update: packages confirmed operational
...
## [3.7.0-alpha.78] - 2026-06-20

### Changed
- Bump version `3.7.0-alpha.74` → `3.7.0-alpha.78` across all three packages (`claude-flow`, `ruflo`, `@claude-flow/cli`)
- Daily maintenance update: packages confirmed operational

Supersedes PRs #33, #34, and #36.
...
| **Ruflo v3.7-alpha.79** | **v3.7.0-alpha.79** | **2026-06-21** | **Daily maintenance update** |
| **Ruflo v3.7-alpha.80** | **v3.7.0-alpha.80** | **2026-06-22** | **Daily maintenance update** |
