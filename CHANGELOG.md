...
## [3.7.0-alpha.76] - 2026-06-08

### Changed
- Bump version `3.7.0-alpha.74` → `3.7.0-alpha.76` across all three packages (`claude-flow`, `ruflo`, `@claude-flow/cli`)
- Add `CHANGELOG.md` entry for `3.7.0-alpha.76` dated 2026-06-08

Supersedes PR #25 (`claude/focused-rubin-9ogN1`).
...
| **Ruflo v3.7-alpha.76** | **v3.7.0-alpha.76** | **2026-06-08** | **Daily version bump** |
