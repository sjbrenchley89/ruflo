...
## [3.7.0-alpha.93] - 2026-07-07

### Changed
- Bump version `3.7.0-alpha.91` → `3.7.0-alpha.93` across all three packages (`claude-flow`, `ruflo`, `@claude-flow/cli`)
- Add `CHANGELOG.md` entry for `3.7.0-alpha.93` dated 2026-07-07
- Daily maintenance update: packages confirmed operational

Supersedes PR #51 (`claude/focused-rubin-rtytj9`), which was still open and unmerged; `alpha.92` is skipped to avoid colliding with that branch's version claim.
