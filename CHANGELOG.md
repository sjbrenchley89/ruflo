...
## [3.7.0-alpha.99] - 2026-07-18

### Changed
- Bump version `3.7.0-alpha.98` → `3.7.0-alpha.99` across all three packages (`claude-flow`, `ruflo`, `@claude-flow/cli`) and both lockfiles
- Add `CHANGELOG.md` entry for `3.7.0-alpha.99` dated 2026-07-18
